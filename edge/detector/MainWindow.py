...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, widthMult=1):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(718*widthMult, 665)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(20, 50, 691*widthMult, 42))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(20, 570, 691*widthMult, 41))
        ...
        self.label_3.setGeometry(QtCore.QRect(230, 50, 351*widthMult, 10))
        self.label_3.setMaximumSize(QtCore.QSize(16777215, 20))
        self.label_3.setText("")
        self.label_3.setObjectName("label_3")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(20, 0, 691*widthMult, 51))
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 500, 691*widthMult, 61))
        self.groupBox.setObjectName("groupBox")
        self.comboBox_model = QtWidgets.QComboBox(self.groupBox)
        self.comboBox_model.setGeometry(QtCore.QRect(10, 30, 671*widthMult, 25))
        self.comboBox_model.setObjectName("comboBox_model")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 718*widthMult, 22))
